...
//			$('#'+_id).hideLoading();
	...
	function criar() {
		...
		var modal_header = $('<div />').addClass('modal-header')
			...
			.append('<button type="button" class="close btn btn-round" data-dismiss="modal" aria-label="Close"><i class="material-icons">close</i></button>');
...
//					}
					...
					if(_ajaxFormOnSubmit != null){
						...
						var originalClick = function(e){
							...
							if (form.valid()){
						    		new Ajax(form.attr('action'), _modal.find('.modal-dialog'))
