...
<div class="card-body card-padding">
  ...
  <div class="form-group ">
    <label for="newsletterNome" class="control-label">Email:</label>
    <input class="form-control required" id="newsletterEmail" type="text" name="newsletter.email" value="${newsletter.email}">
  </div>
